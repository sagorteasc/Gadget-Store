        ...
        <div>
            <div className="bg-[#9538E2] rounded-b-4xl h-full pt-8 pb-12 relative">
                <div className="w-4/6 mx-auto text-center text-white">
                    ...
                    <button className="btn bg-white text-[#9538E2] border-none shadow-none rounded-4xl font-bold text-xl mt-8 mb-0 md:mb-12">Shop Now</button>
                </div>

                <div className='bg-[#FFFFFF30] p-6 w-3/5 h-96 rounded-4xl absolute -translate-x-1/2 left-1/2 top-5/6 hidden md:block'>
