...
const SmartWatches = () => {
    ...
    const filterData = phonesData.filter(category => category.category === 'Smart Watches');
                    ...
                    <div>
                        <div className="grid grid-cols-1 gap-2 w-full lg:grid-cols-[0.15fr_1fr]">
                            <div className="flex flex-col gap-2">
                                ...
                                <button className="btn btn-primary"><NavLink to={"/smartWatches"}>Smart Watches</NavLink></button>
